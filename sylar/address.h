...
public:
    ...
    virtual std::ostream& insert(std::ostream& is) const = 0;
    std::string toString();
...
public:
    ...
    static IPv4Address::ptr Creat(const char* address, uint32_t port = 0);
...
public:
    ...
    static IPv6Address::ptr Creat(const char*  address, uint32_t port = 0);
