...
Address::ptr
Address::LookupAny(const std::string &host,
...
bool Address::operator<(const sylar::Address &rhs) const {
...
IPv4Address::ptr IPv4Address::Creat(const char *address, uint32_t port) {
...
IPv6Address::ptr IPv6Address::Creat(const char *address, uint32_t port) {
