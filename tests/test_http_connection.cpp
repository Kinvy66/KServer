...
void test_pool() {
    sylar::http::HttpConnectionPool::ptr pool(new sylar::http::HttpConnectionPool(
                "www.kinvy66.win", "", 80, 10, 1000 * 30, 5));
...
void run() {
    sylar::Address::ptr addr = sylar::Address::LookupAnyIPAddress("www.kinvy66.win:80");
    ...
    req->setHeader("host", "www.kinvy66.win");
    ...
    auto r = sylar::http::HttpConnection::DoGet("http://www.kinvy66.win:80", 300);
